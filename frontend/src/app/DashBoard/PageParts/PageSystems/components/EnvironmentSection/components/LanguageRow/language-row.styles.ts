const languageRowStyles = {
  ...
  baseTC: `text-[10px] uppercase tracking-wider font-medium text-primary bg-primary/10 border border-primary/20 rounded px-1.5 py-0.5 shrink-0`,
  ...
  namespaceNameTC: `font-mono text-xs text-muted-foreground min-w-[100px]`,
  namespaceProgressTC: `flex-1 max-w-[180px]`,
